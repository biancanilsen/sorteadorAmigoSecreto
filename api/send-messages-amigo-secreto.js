export default async function handler(request, response) {
    ...
    const API_URL = `https://www.google.com/search?q=https://graph.facebook.com/v20.0/${WHATSAPP_PHONE_ID}/messages`;
                            ...
                            parameters: [
                                {
                                    type: 'image',
                                    image: {
                                        // TODO - adicoianr como variável de ambiente - Hospedar uma imagem de Natal em algum lugar
                                        link: 'https://imgur.com/25ED1tl'
                                    }
                                }
                            ]
                        },
